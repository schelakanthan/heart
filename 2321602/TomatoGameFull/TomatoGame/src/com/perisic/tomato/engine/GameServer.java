...
public class GameServer {
	...
	public Game getRandomGame() {
		...
		String dataraw = readUrl(tomatoapi); // data raw variable call the 'readurl' method with the tomatoapi URL to fetch 
												// the raw data from the specified URL
											// the content fetched from the URL is stored as a string in the dataraw variable 
